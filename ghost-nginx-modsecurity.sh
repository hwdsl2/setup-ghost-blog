...
clear
echo 'Welcome! This script installs Ghost blog with Nginx and Modsecurity.'
echo
...
cd /opt/src
wget -qO- https://nodejs.org/download/release/v0.12.12/node-v0.12.12.tar.gz | tar xvz
cd node-v0.12.12
